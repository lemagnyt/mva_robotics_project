...
if __name__ == "__main__":
    ...
    # Load robot
    gym_env = RobotLoader(env_name="Ant-v5", xml_file="./mujoco_menagerie/anybotics_anymal_b/scene.xml", render_mode="human", frame_skip=3).load_robot()


    # Load pre-trained specialized policies 
    model, env = load_policy("models/locomotion_policy", lambda: LocomotionEnv(gym_env, obs_dim=169, use_stif=False, height_estimator=None))
