...
if __name__ == "__main__":
    ...
    # Load robot
    gym_env = RobotLoader(env_name="Ant-v5", xml_file="./mujoco_menagerie/anybotics_anymal_b/scene.xml", render_mode="human", frame_skip=25).load_robot()


    # Load pre-trained specialized policies 
    model, env = load_policy("models/self_righting_policy", lambda: SelfRightingEnv(gym_env, obs_dim=162, use_stif=False, height_estimator=None, max_steps=150))
